...
If you are looking for types of [Jest globals](https://jestjs.io/docs/api), you can import them from `@pkg-nec/jest-globals` package:

```ts
import {describe, expect, it} from '@pkg-nec/jest-globals';
